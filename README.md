...
QPR1=QPR1[QPR1$Date >= "2017-12-31" & QPR1$Date <= "2018-4-1",]
length(QPR1)
...
QPR2=QPR2[QPR2$Date >= "2017-12-31" & QPR2$Date <= "2018-4-1",]
length(QPR2)
...
QPR3
QPR3=QPR3[QPR3["Date"] > "2017-12-31" & QPR3["Date"] <= "2018-4-1",]
dim(QPR3)[1]
...
# subset date first then do the subset for college then do age
# Date for QPR
QPR4=QPR4[QPR4$Date >= "2017-12-31" & QPR4$Date <= "2018-4-1",]
...
# subset date first then do the subset for college then do age
# Date for QPR
QPR5=QPR5[QPR5$Date >= "2017-12-31" & QPR5$Date <= "2018-4-1",]
...
# subset date first then do the subset for college then do age
# Date for QPR
QPR6=QPR6[QPR6$Date >= "2017-12-31" & QPR6$Date <= "2018-4-1",]
...
# subset date first then do the subset for college then do age
# Date for QPR
QPR7=QPR7[QPR7$Date >= "2017-12-31" & QPR7$Date <= "2018-4-1",]
...
# subset date first then do the subset for college then do age
# Date for QPR
QPR8=QPR8[QPR8$Date >= "2017-12-31" & QPR8$Date <= "2018-4-1",]
...
# subset date first then do the subset for college then do age
# Date for QPR
QPR9=QPR9[QPR9$Date >= "2017-12-31" & QPR9$Date <= "2018-4-1",]
...
# subset date first then do the subset for college then do age
# Date for QPR
QPR10=QPR10[QPR10$Date >= "2017-12-31" & QPR10$Date <= "2018-4-1",]
...
QPR11=QPR11[QPR11$Date >= "2017-12-31" & QPR11$Date <= "2018-4-1",]
...
QPR12=QPR12[QPR12$Date >= "2017-12-31" & QPR12$Date <= "2018-4-1",]
...
QPR13=QPR13[QPR13$Date >= "2017-12-31" & QPR13$Date <= "2018-4-1",]
...
QPR14=QPR14[QPR14$Date >= "2017-12-31" & QPR14$Date <= "2018-4-1",]
...
QPR16=QPR16[QPR16$Date >= "2017-12-31" & QPR14$Date <= "2018-4-1",]
...
QPR18=QPR18[QPR18$Date >= "2017-12-31" & QPR14$Date <= "2018-4-1",]
...
QPR19=QPR19[QPR19$Date >= "2017-12-31" & QPR19$Date <= "2018-4-1",]
