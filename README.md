...
typeof(QPR1)
QPR1=QPR1[QPR1 >= "2019-1-01" & QPR1 <= "2019-3-31"]
length(QPR1)
...
QPR3=QPR3[QPR3$Date > "2019-1-01" & QPR3$Date <= "2019-3-31",]
dim(QPR3)[1]
...
QPR4=QPR4[QPR4$Date >= "2019-1-01" & QPR4$Date <= "2019-3-31",]
...
# subset date first then do the subset for college then do age
# Date for QPR
QPR5=QPR5[QPR5$Date >= "2019-1-01" & QPR5$Date <= "2019-3-31",]
...
# subset date first then do the subset for college then do age
# Date for QPR
QPR6=QPR6[QPR6$Date >= "2019-1-01" & QPR6$Date <= "2019-3-31",]
...
# subset date first then do the subset for college then do age
# Date for QPR
QPR7=QPR7[QPR7$Date >= "2019-1-01" & QPR7$Date <= "2019-3-31",]
...
# subset date first then do the subset for college then do age
# Date for QPR
QPR8=QPR8[QPR8$Date >= "2019-1-01" & QPR8$Date <= "2019-3-31",]
...
# subset date first then do the subset for college then do age
# Date for QPR
QPR9=QPR9[QPR9$Date >= "2019-1-01" & QPR9$Date <= "2019-3-31",]
...
# subset date first then do the subset for college then do age
# Date for QPR
QPR10=QPR10[QPR10$Date >= "2019-1-01" & QPR10$Date <= "2019-3-31",]
...
QPR11=QPR11[QPR11$Date >= "2019-1-01" & QPR11$Date <= "2019-3-31",]
...
QPR12=QPR12[QPR12$Date >= "2019-1-01" & QPR12$Date <= "2019-3-31",]
...
QPR13=QPR13[QPR13$Date >= "2019-1-01" & QPR13$Date <= "2019-3-31",]
...
QPR14=QPR14[QPR14$Date >= "2019-1-01" & QPR14$Date <= "2019-3-31",]
...
QPR16=QPR16[QPR16$Date >= "2019-1-01" & QPR14$Date <= "2019-3-31",]
...
QPR18=QPR18[QPR18$Date >= "2019-1-01" & QPR14$Date <= "2019-3-31",]
...
QPR19=QPR19[QPR19$Date >= "2019-1-01" & QPR19$Date <= "2019-3-31",]
