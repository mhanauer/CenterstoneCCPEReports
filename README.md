...
totalAdults2016 = data.frame(gpraAdultAll$PARTID, gpraAdultAll$YEAR.x)
colnames(totalAdults2016) =c("PARTID", "YEAR.x")
totalAdults2016= data.frame(subset(totalAdults2016, YEAR.x == 2016))


totalYouth2016 = data.frame(gpraYouthAll$PARTID, gpraYouthAll$YEAR.x)
colnames(totalYouth2016) =c("PARTID", "YEAR.x")
totalYouth2016= data.frame(subset(totalYouth2016, YEAR.x == 2016))

dim(totalAdults2016)[1]+dim(totalYouth2016)[1]
375/160 

totalAdults2017 = data.frame(gpraAdultAll$PARTID, gpraAdultAll$YEAR.x)
colnames(totalAdults2017) =c("PARTID", "YEAR.x")
totalAdults2017= data.frame(subset(totalAdults2017, YEAR.x == 2017))


totalYouth2017 = data.frame(gpraYouthAll$PARTID, gpraYouthAll$YEAR.x)
colnames(totalYouth2017) =c("PARTID", "YEAR.x")
totalYouth2017= data.frame(subset(totalYouth2017, YEAR.x == 2017))

dim(totalAdults2017)[1]+dim(totalYouth2017)[1]
