...
Goal3ObjectiveIBaseline3month = data.frame(gpraAdultAll$YEAR.x, gpraAdultAll$CIG30D.x,gpraAdultAll$VAP30D.x, gpraAdultAll$ALC30D.x, gpraAdultAll$BINGE530D.x, gpraAdultAll$MJ30D.x, gpraAdultAll$ILL30D.x, gpraAdultAll$RX30D.x, gpraAdultAll$SPICE30D.x, gpraAdultAll$INJECT30D.x, gpraAdultAll$CIG30D.y,gpraAdultAll$VAP30D.y, gpraAdultAll$ALC30D.y, gpraAdultAll$BINGE530D.y, gpraAdultAll$MJ30D.y, gpraAdultAll$ILL30D.y, gpraAdultAll$RX30D.y, gpraAdultAll$SPICE30D.y, gpraAdultAll$INJECT30D.y)            
...
Goal3ObjectiveIBaseline3month$gpraAdultAll.YEAR.x
Goal3ObjectiveIBaseline3month2016 = subset(Goal3ObjectiveIBaseline3month, gpraAdultAll.YEAR.x == 2016)
head(Goal3ObjectiveIBaseline3month2016)
...
## This is for year 2016 versus 2017.  So keep everything the same, but add a subset for 2016 and 2017.  Then take the differnece between each each baseline and 3 month for 2016 and 2017.  Then it is the change for 2016 versus the change in 2017.
